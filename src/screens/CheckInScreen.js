...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: COLORS.textPrimary, fontSize: 18, fontWeight: '800', letterSpacing: 2 },
  plateSection: {
    margin: SPACING.md, padding: SPACING.lg,
    backgroundColor: COLORS.surface, borderRadius: RADIUS.md,
    borderWidth: 2, borderColor: COLORS.primary, alignItems: 'center',
  },
  plateLabel: { color: COLORS.primary, fontSize: 10, fontWeight: '700', letterSpacing: 3, marginBottom: SPACING.sm },
  plateInput: {
  ...
  submitBtnText: { color: COLORS.bg, fontWeight: '900', fontSize: 14, letterSpacing: 2 },
});
