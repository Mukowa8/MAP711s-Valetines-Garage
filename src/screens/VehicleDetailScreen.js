          ...
          <View style={styles.tasksSectionHeader}>
            ...
            {vehicle.status === 'in-progress' && (
              <TouchableOpacity style={styles.addTaskBtn} onPress={() => setShowAddTask(!showAddTask)}>
                <Ionicons name={showAddTask ? 'close' : 'add'} size={18} color={COLORS.onPrimary} />
            ...
            tasks.map((task) => (
              <View key={task.id} style={[styles.taskCard, task.completed && styles.taskCardDone]}>
                ...
                <View style={styles.taskHeader}>
                  ...
                  >
                    {task.completed && <Ionicons name="checkmark" size={14} color={COLORS.onPrimary} />}
                  </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  plateBadge: {
    ...
    shadowColor: COLORS.primary, shadowOpacity: 0.18, shadowRadius: 10,
    shadowOffset: { width: 0, height: 4 }, elevation: 3,
  },
  plate: { color: COLORS.onPrimary, fontWeight: '900', fontSize: 18, letterSpacing: 3 },
  reportBtn: {
    width: 42, height: 42, borderRadius: 14,
    backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border,
    justifyContent: 'center', alignItems: 'center',
  ...
  addTaskBtnText: { color: COLORS.onPrimary, fontWeight: '800', fontSize: 11, letterSpacing: 1 },
  addTaskForm: {
  ...
  addTaskSubmitText: { color: COLORS.onPrimary, fontWeight: '800', fontSize: 12, letterSpacing: 1 },
  empSelectRow: {
  ...
  checkOutBtn: {
    ...
    shadowColor: COLORS.danger, shadowOpacity: 0.2, shadowRadius: 10,
    shadowOffset: { width: 0, height: 4 }, elevation: 4,
  },
  checkOutBtnText: { color: COLORS.onPrimary, fontWeight: '900', fontSize: 14, letterSpacing: 2 },
  // Modal
  modalOverlay: { flex: 1, backgroundColor: '#0F172A99', justifyContent: 'flex-end' },
  modalCard: {
