      ...
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.addBtn} onPress={() => setShowAdd(!showAdd)}>
            <Ionicons name={showAdd ? 'close' : 'add'} size={18} color={COLORS.bg} />
...
const styles = StyleSheet.create({
  ...
  addBtn: {
    ...
    backgroundColor: COLORS.primary, paddingVertical: 8, paddingHorizontal: 14, borderRadius: RADIUS.sm,
  },
  addBtnText: { color: COLORS.bg, fontWeight: '800', fontSize: 11, letterSpacing: 1 },
  addForm: {
  ...
  submitBtnText: { color: COLORS.bg, fontWeight: '800', fontSize: 12, letterSpacing: 1 },
  statsBanner: {
