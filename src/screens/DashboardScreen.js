  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      <View style={styles.header}>
        <View>
          <Text style={styles.headerSub}>VALENTINE'S</Text>
...
const styles = StyleSheet.create({
  ...
  headerSub: { color: COLORS.primary, fontSize: 11, fontWeight: '700', letterSpacing: 4 },
  headerTitle: { color: COLORS.textPrimary, fontSize: 28, fontWeight: '900', letterSpacing: 2 },
  headerBadge: {
  ...
  checkInBtnText: { color: COLORS.bg, fontWeight: '800', fontSize: 11, letterSpacing: 1 },
  ...
  vehiclePlateWrap: {
    backgroundColor: COLORS.primary, paddingVertical: 4, paddingHorizontal: 10, borderRadius: RADIUS.sm,
  },
  vehiclePlate: { color: COLORS.bg, fontWeight: '900', fontSize: 14, letterSpacing: 2 },
