...
const styles = StyleSheet.create({
  ...
  plateBadge: { backgroundColor: COLORS.primary, paddingVertical: 4, paddingHorizontal: 10, borderRadius: RADIUS.sm },
  plate: { color: COLORS.bg, fontWeight: '900', fontSize: 14, letterSpacing: 2 },
  ...
  empInitial: { color: COLORS.bg, fontWeight: '900', fontSize: 20 },
